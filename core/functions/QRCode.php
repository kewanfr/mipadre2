...
class QRCode
{
  ...
  //Function which is used to return qrcode image url.
  public function QRCODEURL($size = 400, $filename = null)
  {

    $url = $this->apiUrl;
    $url = $url . "?chs={$size}x{$size}&cht=qr&choe=UTF-8&chl=" . urlencode($this->data);
    return $url;
  }
}
